...
QUEST_DATA["4"] := Map("Name", "Make Golden Pets", "Regex", "i)golden(?!.*best)", "Status", "Manual", "Zone", "Best")
QUEST_DATA["5"] := Map("Name", "Make Rainbow Pets", "Regex", "i)rainbow(?!.*best)", "Status", "Manual", "Zone", "Best")
...
QUEST_DATA["12"] := Map("Name", "Upgrade Potions", "Regex", "i)upg.*pot", "Status", "Manual", "Zone", "Best")
QUEST_DATA["13"] := Map("Name", "Upgrade Enchants", "Regex", "i)upg.*ench", "Status", "Manual", "Zone", "Best")
QUEST_DATA["14"] := Map("Name", "Collect Potions", "Regex", "i)col.*pot", "Status", "Auto", "Zone", "Best")
QUEST_DATA["15"] := Map("Name", "Collect Enchants", "Regex", "i)col.*ench", "Status", "Auto", "Zone", "Best")
QUEST_DATA["19"] := Map("Name", "Fuse Pets", "Regex", "i)fuse", "Status", "Manual", "Zone", "Best")
QUEST_DATA["20"] := Map("Name", "Hatch Best Egg", "Regex", "i)your.*bes", "Status", "Auto", "Zone", "Best")
...
QUEST_DATA["40"] := Map("Name", "Make Golden Pets from Best Egg", "Regex", "i)golden.*best", "Status", "Auto", "Zone", "Best")
QUEST_DATA["41"] := Map("Name", "Make Rainbow Pets from Best Egg", "Regex", "i)rainbow.*best", "Status", "Auto", "Zone", "Best")
...
QUEST_DATA["54"] := Map("Name", "Mail Gifts to Other Players", "Regex", "i)mail", "Status", "Manual", "Zone", "Best")
